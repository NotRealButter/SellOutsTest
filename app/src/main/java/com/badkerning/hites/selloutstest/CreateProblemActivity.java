package com.badkerning.hites.selloutstest;
...
public class CreateProblemActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(CreateProblemActivity.this, "dickbutt", Toast.LENGTH_SHORT).show();
                Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
                AlertDialog.Builder builder = new AlertDialog.Builder(CreateProblemActivity.this);
                ...
                AlertDialog problemDialog = builder.create();
                problemDialog.show();
    ...
    public void createFirstCard(){
        TextView cardViewer = (TextView) findViewById(R.id.card_text);
        cardViewer.setText(R.string.setup);
    }
